 ...
 * Answers Model
 *
 * @property \Cake\ORM\Association\BelongsTo $Researches
 * @property \Cake\ORM\Association\BelongsTo $Paths
 *
...
class AnswersTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['researches_id'], 'Researches'));
